...
export default function NewsDetailPage() {
  ...
  return (
    <View className="bg-white rounded-2xl mx-8 my-2 mt-8 shadow-md h-[700px] p-6">
      <ScrollView >
      {/* <Text>뉴스 디테일 페이지 - {newsId}</Text> */}
        ...
        <View className="my-4 ml-2 mr-12">
          <View className="flex-row mb-2">
            ...
            <View>
              ...
              <Text className="text-base mt-2">{newsInfo.newsSummary}</Text>
            </View>
          </View>
        </View>
        ...
        <View className="border-t border-gray-200 mt-8 mb-2"></View>
        <Text className="text-sm text-gray-500">
        해당 기사의 저작권은 {newsInfo.press}에 었으며, 자세한 내용은 원문 링크를 통해 확인할 수 있습니다.
        </Text>
