...
public enum ExceptionCode {
    ...
    NEWS_LETTER_NOT_FOUND(HttpStatus.NOT_FOUND, "해당하는 뉴스레터가 존재하지 않습니다.", 3004),
    NEWS_SCRAP_NOT_FOUND(HttpStatus.NOT_FOUND, "해당하는 뉴스 스크랩이 존재하지 않습니다.", 3004),
    NOTIFICATION_NOT_FOUND(HttpStatus.NOT_FOUND, "해당하는 알림이 존재하지 않습니다.", 3004),
    USER_STOCK_NOT_FOUND(HttpStatus.NOT_FOUND, "해당하는 유저 주식이 존재하지 않습니다.", 3005),
    USER_NOTIFICATION_NOT_FOUND(HttpStatus.NOT_FOUND, "해당하는 유저 알림이 존재하지 않습니다.", 3005),
    STOCK_ALREADY_EXISTS(HttpStatus.NOT_FOUND, "이미 존재하는 주식입니다.", 3006),
    USER_STOCK_ALREADY_EXISTS(HttpStatus.NOT_FOUND, "이미 존재하는 유저 주식입니다.", 3006),
